...
import me.help.betterlocalchat.handlers.TabHandler;
...
public class BetterLocalChat extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            registerCommands(commandHandler, tabHandler);
    ...
    private void registerCommands(CommandHandler commandHandler, TabHandler tabHandler) {
        ...
        getCommand("chatspy").setExecutor(commandHandler);
        getCommand("channels").setExecutor(commandHandler);

        getCommand("betterlocalchat").setExecutor(commandHandler);
        getCommand("betterlocalchat").setTabCompleter(tabHandler);
    }
